...
Revision ID: 9e58585d54dc
Revises: 
Create Date: 2024-09-14 21:19:20.974837
...
def upgrade():
    ...
    with op.batch_alter_table('User', schema=None) as batch_op:
        batch_op.add_column(sa.Column('files', sa.String(length=120), nullable=True))
...
def downgrade():
    ...
    with op.batch_alter_table('User', schema=None) as batch_op:
        batch_op.add_column(sa.Column('image_file', sa.VARCHAR(length=120), nullable=False))
